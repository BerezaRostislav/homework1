...
class Order(models.Model):
    total_price = models.DecimalField(decimal_places=2, max_digits=10, default=0) #сумма заказа
...
class ProductInOrder(models.Model):
    ...
    def save(self, *args, **kwargs):
        prise_per_item = self.product.price
        self.price_per_item = prise_per_item
        self.total_price = self.numb * self.price_per_item
